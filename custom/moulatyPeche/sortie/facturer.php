...
// ============================================================================
$sqlSortie = "SELECT s.*, u.firstname, u.lastname
...
// ============================================================================
print '<form method="POST" action="facturation_process.php?id_sortie='.$id_sortie.'">';
...
print '<div class="total-label">'.$langs->trans("TotalGeneral").'</div>';
