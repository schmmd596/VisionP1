<?php
/**
 * Nouvelle Sortie - Interface de création de sorties
 */
...
print '<td>'.$form->selectarray('fk_entrepot_source', $entrepots, $fk_entrepot_source, 1).'</td>';
print '</tr>';

// --- Mode de sortie (fixé à transfert interne) ---
$mode_sortie = '0';
print '<tr>';
...
print '<i class="fa fa-right-left"></i> '.$langs->trans("TransfertInterne");
print '</span>';
print '<input type="hidden" name="mode_sortie" value="0">';
print '</td>';
print '</tr>';
...
if (empty($fk_entrepot_source) || empty($fk_entrepot_dest)) {
